...
const NearbyDealers = () => {
  return (
    <div className=" mt-5">
      <div>
      <h2 className='mt-5 text-center fs-2 fw-bold mb-5' style={{color:'tomato'}}>NEARBY DEALER POINTS</h2>
      </div>
      <div>
        <MapContainer
        ...
        >
          <TileLayer
            attribution='&copy; PRAN Dealer Inventory'
          />
          <Marker position={[23.78163527997635, 90.42549473239008]}>
            <Popup>
              PRAN-RFL Center, Badda, Dhaka
            </Popup>
          </Marker>
