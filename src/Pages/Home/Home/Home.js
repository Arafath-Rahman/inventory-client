...
const Home = () => {
  return (
    <div className="container mx-auto d-flex flex-column flex-lg-row gap-4 justify-content-between" id="home">
      <div className="container-fluid d-flex flex-column justify-content-center my-3 mx-3 mx-lg-0">
        <h1 className="fs-1 text-danger fw-bold">Tired of managing your Inventory in old-fashioned way?</h1>
